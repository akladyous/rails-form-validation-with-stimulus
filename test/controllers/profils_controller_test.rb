...
class ProfilsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create profil" do
    assert_difference("Profil.count") do
      post profils_url, params: { profil: { age: @profil.age, birthdate: @profil.birthdate, first_name,: @profil.first_name,, last_name,: @profil.last_name, } }
    end
  ...
  test "should update profil" do
    patch profil_url(@profil), params: { profil: { age: @profil.age, birthdate: @profil.birthdate, first_name,: @profil.first_name,, last_name,: @profil.last_name, } }
